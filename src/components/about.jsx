      ...
      <div className="container mx-auto  max-w-7xl grid md:grid-cols-2 ">
        ...
        <animated.div id="animate" className="p-4" style={animationProps}>
          ...
          <motion.button
            ...
            className=" box block py-2.5 px-5 me-2 mb-2 mt-10 t-sm font-medium text-white focus:outline-none bg-indigo-500 rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
          >
            <svg
